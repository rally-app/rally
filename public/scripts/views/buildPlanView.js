BuildPlanView = Backbone.View.extend({
  ...
  template: '<div class="buildPlan"><p>I want to <input type="text" name="hostWhat" placeholder="eat/drink"></input>near <input type="text" name="hostWhere" placeholder="location"></input> at <input type="date" name="hostWhen" placeholder="time"></input> with <input type="text" name="hostWho" placeholder="these people"></input>.</p><button type="button" class="createEvent">Check Mark Image</button><button type="reset" class="clear">Clear</button></div>',
